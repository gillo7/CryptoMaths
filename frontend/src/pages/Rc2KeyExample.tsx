    ...
    <div className="explorer">
      ...
      <div className="multibox">
        <div className="multibox-row">
          <span className="multibox-label">RC2 key</span>
      ...
      <p className="demo-note">
        This key is 16 bytes (128 bits), unlike DES's fixed 8-byte key -
        RC2's whole point was letting the key length vary, anywhere from 1
        to 128 bytes.
      </p>
    </div>
  )
